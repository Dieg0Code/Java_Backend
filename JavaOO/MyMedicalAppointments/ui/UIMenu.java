...
public class UIMenu {
    ...
    private static void authUser(int userType) {
        ...
        doctors.add(new Doctor("Alex Martínez", "alex@email.com"));
        doctors.add(new Doctor("Karen Sosa", "karen@email.com"));
        doctors.add(new Doctor("Rocío Gómez", "rocio@email.com"));

        ArrayList<Patient> patients = new ArrayList<>();
        patients.add(new Patient("Diego Obando", "diego@email.com"));
        patients.add(new Patient("Roberto Rodrígez", "roberto@email.com"));
        patients.add(new Patient("Carlos Sánchez", "carlos@email.com"));
